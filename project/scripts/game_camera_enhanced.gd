extends Camera2D
class_name GameCameraEnhanced

## ═══════════════════════════════════════════════════════════════════════════════
## GameCameraEnhanced — Full-featured game camera with cinematic capabilities
## ═══════════════════════════════════════════════════════════════════════════════
##
## Extends standard camera with: target following, look-ahead, world bounds
## clamping, multi-mode shake, zoom effects, dead zones, cinematic mode,
## focus points, and smooth transitions. Drop-in replacement for Camera2D.
...
var _trauma: float = 0.0  # Alternative shake metric
...
func start_cinematic(points: Array[Dictionary]) -> void:
	...
	Each point: { "position": Vector2, "zoom": float, "duration": float, "ease": Tween.EaseType }
	"""
