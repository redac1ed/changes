...
## ═══════════════════════════════════════════════════════════════════════════════
## Checkpoint — Saves respawn position when ball passes through
## ═══════════════════════════════════════════════════════════════════════════════
##
## Flag-style checkpoint that activates on ball contact.
## Features animated flag, activation particles, and chime.
