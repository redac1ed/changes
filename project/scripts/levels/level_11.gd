...
const SUBTITLE_VICTORY_1 := "Oh look, we are now in a snow biome. How interesting..."
...
func get_custom_star_rules() -> Dictionary:
	return {
		"three_shots": 9, "three_time": 3600.0,
		"two_shots": 11,   "two_time": 3600.0,
		"one_shots": 14
	}
...
func _play_random_victory_audio() -> void:
	...
	victory_player.stream = load("res://assets/audio/snowbiome_transition.mp3")
