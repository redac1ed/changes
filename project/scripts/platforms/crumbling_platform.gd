...
## ═══════════════════════════════════════════════════════════════════════════════
## CrumblingPlatform — Breaks apart after brief contact, scatters debris
## ═══════════════════════════════════════════════════════════════════════════════
##
## Once the ball touches this platform, it cracks, shakes, then explodes
## into fragments. Each fragment is a separate node that falls with physics.
## Optionally respawns after a delay.
...
func _draw_cracks(rect: Rect2) -> void:
	...
	# Progressive cracks as crumble approaches
...
func _draw_rebuild_effect(rect: Rect2) -> void:
	# Glowing outline during rebuild
