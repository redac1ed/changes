...
## ═══════════════════════════════════════════════════════════════════════════════
## FallingPlatform — Drops after ball lands, respawns after delay
## ═══════════════════════════════════════════════════════════════════════════════
##
## When the ball touches this platform, it shakes briefly, then falls.
## After a configurable delay it respawns at its original position
...
func _process_shaking(delta: float) -> void:
	...
	# Warning particles during shake
	_warning_particles.emitting = true
	
	# Flash faster as about to fall
...
func _draw_platform_details(rect: Rect2) -> void:
	...
	# Warning indicator — exclamation mark when shaking
