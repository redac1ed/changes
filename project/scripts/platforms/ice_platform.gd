...
## ═══════════════════════════════════════════════════════════════════════════════
## IcePlatform — Slippery surface with reduced friction
## ═══════════════════════════════════════════════════════════════════════════════
##
## The ball slides more freely on this platform. Features ice crystal visuals,
## frost particle effects, and a slight glide boost.
...
func _platform_ready() -> void:
	...
	# Generate random frost crystal positions
...
func _on_ball_landed(ball: RigidBody2D) -> void:
	# Apply slide boost — push ball in its current direction
	if ball:
...
func _draw_platform_details(rect: Rect2) -> void:
	# Ice surface sheen - diagonal gradient lines
