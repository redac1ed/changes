...
## ═══════════════════════════════════════════════════════════════════════════════
## OneWayPlatform — Can be passed through from below, solid from above
## ═══════════════════════════════════════════════════════════════════════════════
##
## The ball can jump through from below and land on top.
## Uses Godot's one-way collision feature with visual indicators.
...
func _draw_platform_details(rect: Rect2) -> void:
	# Dashed bottom edge to indicate pass-through
	if dashed_edge:
		var dash_length := 8.0
		var gap_length := 5.0
	...
	# Upward arrows to show direction
	if show_arrows:
