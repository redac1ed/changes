...
## ═══════════════════════════════════════════════════════════════════════════════
## PlayerAbilityManager — Special Moves & Powerups
## ═══════════════════════════════════════════════════════════════════════════════
##
## Manages active abilities like Boost, Brake, and Shield.
## Handles cooldowns, input detection, and effect application.
